package com.coddicted.school.student.controller;
...
import com.coddicted.school.student.repository.StudentRepository;
...
@Controller
@RequestMapping(path = "/student") // This means URL's start with /enrolment (after Application path)
