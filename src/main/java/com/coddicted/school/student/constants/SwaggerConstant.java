package com.coddicted.school.student.constants;

public interface SwaggerConstant
{
    String DESCRIPTION = "Student Enrolment API";
    String ADD_STUDENT = "Enrol a new Student";
    String GET_STUDENT_LIST = "Get all the enrolled students";
    ...
    String STUDENT_GUARDIAN_NAME = "Student's guardian name (if any applicable)";
